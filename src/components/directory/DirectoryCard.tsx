...
function WhatsAppIcon({ className, ...props }: { className?: string } & React.ComponentProps<'svg'>) {
  return (
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-3 text-base leading-[1.6] text-[var(--card-text)]">
          {entry.description}
        </p>
